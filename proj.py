...
def runES():
    ...
    text.insert(END,"Confirmed Cases ES MAE : "+mae+"\n")
    text.insert(END,"Confirmed Cases ESS MSE : "+mse+"\n")
    ...
    text.insert(END,"Recovered Cases ES MAE : "+mae+"\n")
    text.insert(END,"Recovered Cases ES MSE : "+mse+"\n")
    ...
    text.insert(END,"Death Cases ES MAE : "+mae+"\n")
    text.insert(END,"Death Cases ES MSE : "+mse+"\n")
